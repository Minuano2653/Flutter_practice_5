...
class DiscountsCubit extends Cubit<List<Discount>> {
  DiscountsCubit() : super([]) {
    _initializeDiscounts();
  }

  void _initializeDiscounts() {
    final users = [
      User(
        id: 'u2',
        name: 'ВладиМир',
    ...
    final discounts = [
      ...
      Discount(
        ...
        oldPrice: '44 999',
        imageUrl:
        'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTzZD1CE-CZ2I3oXzPHGfFh14UwhuLreU8FAIFTJ2AmIEDsIV3-qZ-ghxraXwT1671VaoGuK55jxoXVLpB9_pnagZCHDBVq7i3aLS1zUBmyMQ96eY09wxBR',
        storeName: 'Эльдорадо',
        author: users[2],
        description:
